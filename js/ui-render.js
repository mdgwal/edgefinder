...
function renderSetupsFullView(){
  ...
  const barWidth = v => Math.round(((v + 2) / 4) * 100);
  ...
  scored.forEach((a, idx) => {
    ...
    rows += '<tr class="st-data-row '+rowBgClass(a.total)+'" onclick="_setupRowToggle('+idx+')" style="cursor:pointer">'
      +'<td class="asset-name" style="color:'+tc+'">'+a.name+'<span class="st-chevron" style="font-size:8px;color:rgba(255,255,255,.2);margin-left:5px">▾</span></td>'
      ...
      +'<td style="'+hm(ppi)+'">'+cv(ppi)+'</td>'
      +'<td style="'+hm(pce)+'">'+cv(pce)+'</td>'
      +'<td style="'+hm(a.empChg)+'">'+cv(a.empChg)+'</td>'
      +'<td style="'+hm(a.unemploy)+'">'+cv(a.unemploy)+'</td>'
      +'<td style="'+hm(a.rates)+'">'+cv(a.rates)+'</td>'
    +'</tr>'
    +'<tr class="st-expand-row"><td colspan="17" class="st-expand-cell">'
    +'<div class="st-expand-panel"><div class="st-expand-inner">'
    +'<div class="st-breakdown-grid">'
    +'<div class="st-bd-group"><div class="st-bd-group-label">Sentiment</div>'
    +'<div class="st-bd-item"><span class="st-bd-key">COT</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.cot)+'%;background:'+barColor(a.cot)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.cot)+'">'+sigLabel(a.cot)+'</span></div>'
    +'<div class="st-bd-item"><span class="st-bd-key">Retail Pos</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.retail)+'%;background:'+barColor(a.retail)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.retail)+'">'+sigLabel(a.retail)+'</span></div>'
    +'<div class="st-bd-item"><span class="st-bd-key">Seasonality</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.seasonal)+'%;background:'+barColor(a.seasonal)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.seasonal)+'">'+sigLabel(a.seasonal)+'</span></div>'
    +'</div>'
    +'<div class="st-bd-group"><div class="st-bd-group-label">Technical</div>'
    +'<div class="st-bd-item"><span class="st-bd-key">Trend</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.trend)+'%;background:'+barColor(a.trend)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.trend)+'">'+sigLabel(a.trend)+'</span></div>'
    +'<div class="st-bd-item"><span class="st-bd-key">GDP</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.gdp)+'%;background:'+barColor(a.gdp)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.gdp)+'">'+sigLabel(a.gdp)+'</span></div>'
    +'</div>'
    +'<div class="st-bd-group"><div class="st-bd-group-label">Macro</div>'
    +'<div class="st-bd-item"><span class="st-bd-key">CPI / Inflation</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.inflation)+'%;background:'+barColor(a.inflation)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.inflation)+'">'+sigLabel(a.inflation)+'</span></div>'
    +'<div class="st-bd-item"><span class="st-bd-key">Emp Change</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.empChg)+'%;background:'+barColor(a.empChg)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.empChg)+'">'+sigLabel(a.empChg)+'</span></div>'
    +'<div class="st-bd-item"><span class="st-bd-key">Rates</span><div class="st-bd-bar-track"><div class="st-bd-bar" style="width:'+barWidth(a.rates)+'%;background:'+barColor(a.rates)+'"></div></div><span class="st-bd-val" style="color:'+sigColor(a.rates)+'">'+sigLabel(a.rates)+'</span></div>'
    +'</div>'
    +'</div>'
    +'<div class="st-insight-block"><span class="st-insight-lbl">TRADE INSIGHT</span><span class="st-insight-txt">'+insight+'</span></div>'
    +'</div></div></td></tr>';
  });
